...
{
	public class FileBrowserPlugin : MonoBehaviour, IListViewAdapter
	{
		#region Structs
		[Serializable]
		...
		private static FileBrowserPlugin m_instance = null;
		private static FileBrowserPlugin instance
		{
			get
			{
				if( m_instance == null )
				{
					m_instance = Instantiate<GameObject>( Resources.Load<GameObject>( "SimpleFileBrowserCanvas" ) ).GetComponent<FileBrowserPlugin>();
